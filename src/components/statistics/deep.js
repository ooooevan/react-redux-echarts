...
class _deep extends React.Component {
  ...
  componentDidMount() {
    ...
    const statisticsDeepChart = ReactDOM.findDOMNode(this.refs.statisticsDeepChart);
  ...
  componentWillReceiveProps(nextProps, nextState) {
    ...
    if (deep.series && deep.series[0].data && deep.series[0].data && deep.series[0].data[0]) {
      ...
      const percentList = deep.series[0].data;
      const numList = deep.xAxis[0].num;
    ...
    return	(<div>
      <div className="panel">
        ...
        <div className="panelBody">
          <div className="statisticsDeepChart" ref="statisticsDeepChart" />
        </div>
      </div>
      <div className="panel">
...
export default connect(mapStateToProps, statisticsAction)(_deep);
