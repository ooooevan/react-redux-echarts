...
class _stay extends React.Component {
  ...
  componentDidMount() {
    ...
    const statisticsStayChart = ReactDOM.findDOMNode(this.refs.statisticsStayChart);
  ...
  componentWillReceiveProps(nextProps, nextState) {
    ...
    if (stay.series && stay.series[0] && stay.series[0].data && stay.series[0].data[0]) {
      ...
      const numList = stay.series[0].data;
    ...
    return	(<div>
      <div className="panel">
        ...
        <div className="panelBody">
          <div className="statisticsStayChart" ref="statisticsStayChart" />
        </div>
      </div>
      <div className="panel">
...
export default connect(mapStateToProps, statisticsAction)(_stay);
