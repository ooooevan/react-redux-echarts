...
class _customerAvg extends React.Component {
  ...
  componentDidMount() {
    ...
    const statisticsAvgChart = ReactDOM.findDOMNode(this.refs.statisticsAvgChart);
    ...
    return	(<div>
      <div className="panel">
        ...
        <div className="panelBody">
          <div className="statisticsAvgChart" ref="statisticsAvgChart" />
        </div>
      </div>
      <div className="panel">
...
export default connect(mapStateToProps, statisticsAction)(_customerAvg);
