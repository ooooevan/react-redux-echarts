...
class _oldOrNew extends React.Component {
  ...
  componentWillReceiveProps(nextProps, nextState) {
    if (this.props !== nextProps) {
      ...
      const new1List = oldOrNew.xAxis[0].num1New;
      const old1List = oldOrNew.xAxis[0].num1Old;
      const new2List = oldOrNew.xAxis[0].num2New;
      const old2List = oldOrNew.xAxis[0].num2Old;
  ...
  componentDidMount() {
    ...
    const dom = ReactDOM.findDOMNode(this.refs.compareOldOrNewChart);
 ...
 //
  ...
  render() {
    const {timeList, new1List, old1List, percent1List, new2List, old2List, percent2List} = this.state;
    const rows = [];
    let time1,
      time2;
    if (timeList) {
    ...
    return (<div className="chartWrapper">
      ...
      <div className="panel">
        ...
        <div className="panelBody">
          <div ref="compareOldOrNewChart" className="compareOldOrNewChart" />
        </div>
      </div>
      <div className="panel">
...
export default connect(mapStateToProps, compareAction)(_oldOrNew);
