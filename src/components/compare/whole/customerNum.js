...
class _customerNum extends React.Component {
 ...
 //        this.props.comparenumInit(this.state.time,this.state.chartPage);
  ...
  componentDidMount() {
    ...
    const dom = ReactDOM.findDOMNode(this.refs.compareCustomerNumChart);
 ...
 //
  ...
  componentWillReceiveProps(nextProps, nextState) {
    if (this.props !== nextProps) {  // 当props改变时才触发。只改变selectTime不触发
      ...
      const num1List = customerNum.series[0].data;
      const num2List = customerNum.series[1].data;
    ...
    return (<div className="chartWrapper">
      ...
      <div className="panel">
        ...
        <div className="panelBody">
          <div ref="compareCustomerNumChart" className="compareCustomerNumChart" />
        </div>
      </div>
      <div className="panel">
...
export default connect(mapStateToProps, compareAction)(_customerNum);
