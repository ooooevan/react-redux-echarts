...
class _out extends React.Component {
 ...
 //        this.props.compareCustomerNumInit(this.state.time,this.state.chartPage);
  ...
  componentDidMount() {
    ...
    const dom = ReactDOM.findDOMNode(this.refs.compareOutChart);
  ...
  componentWillReceiveProps(nextProps, nextState) {
    ...
    if (out.series[0].data && out.series[0].data && out.series[0].data[0]) {
      ...
      const num1List = out.xAxis[0].out1Num;
      const num2List = out.xAxis[0].out2Num;
    ...
    return (<div className="chartWrapper">
      ...
      <div className="panel">
        ...
        <div className="panelBody">
          <div ref="compareOutChart" className="compareOutChart" />
        </div>
      </div>
      <div className="panel">
...
export default connect(mapStateToProps, compareAction)(_out);
