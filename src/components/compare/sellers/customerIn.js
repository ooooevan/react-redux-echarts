...
class _sellersIn extends React.Component {
 ...
 //      
    ...
    render(){
        ...
        return <div>
      				<div className="panel">
                  <div className="panelHead">顾客入店量对比</div>
                  <div className="panelBody">
                  <div ref="compareSellerInChart" className="compareSellerInChart"></div>
                  </div>
              </div>
							<div className='panel'>
  		    				<div className="panelHead">顾客入店量信息</div>
  					    			<div className="panelBody">
...
let sellersIn=connect(mapStateToProps,compareAction)(_sellersIn);
export default sellersIn;
