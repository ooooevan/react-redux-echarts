...
class _active extends React.Component {
  ...
  componentDidMount() {
    ...
    const singleSellerActiveChart = ReactDOM.findDOMNode(this.refs.singleSellerActiveChart);
  ...
  componentWillReceiveProps(nextProps, nextState) {
    ...
    if (active.series && active.series[0] && active.series[0].data && active.series[0].data[0]) {
      const timeList = active.xAxis[0].data.reverse();
      const numList = active.series[0].data.reverse();
    ...
    return	(<div>
      <div className="panel">
        ...
        <div className="panelBody">
          <div className="singleSellerActiveChart" ref="singleSellerActiveChart" />
        </div>
      </div>
      <div className="panel">
...
export default connect(mapStateToProps, sellersAction)(_active);
