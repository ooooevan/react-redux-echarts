...
class _customerAvg extends React.Component {
  ...
  componentDidMount() {
    ...
    const singleSellerCustomerAvgChart = ReactDOM.findDOMNode(this.refs.singleSellerCustomerAvgChart);
  ...
  componentWillReceiveProps(nextProps, nextState) {
    ...
    if (customerAvg.series && customerAvg.series[0] && customerAvg.series[0].data && customerAvg.series[0].data[0]) {
      const timeList = customerAvg.xAxis.data;
      const numList = customerAvg.series[0].data;
      const percentList = customerAvg.series[1].data;
    ...
    return (<div>
      <div className="panel">
        ...
        <div className="panelBody">
          <div className="singleSellerCustomerAvgChart" ref="singleSellerCustomerAvgChart" />
        </div>
      </div>
      <div className="panel">
