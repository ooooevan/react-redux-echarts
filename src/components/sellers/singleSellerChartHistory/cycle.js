...
class _cycle extends React.Component {
  ...
  componentDidMount() {
    ...
    const singleSellerCycleChart = ReactDOM.findDOMNode(this.refs.singleSellerCycleChart);
    ...
    return (<div>
      <div className="panel">
        ...
        <div className="panelBody">
          <div className="singleSellerCycleChart" ref="singleSellerCycleChart" />
        </div>
      </div>
      <div className="panel">
...
export default  connect(mapStateToProps, sellersAction)(_cycle);
