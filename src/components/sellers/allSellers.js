...
class _Chart extends React.Component {
  ...
  componentDidMount() {
    ...
    const domLine = ReactDOM.findDOMNode(this.refs.allSellersLineChart);
  ...
  componentWillUpdate(nextProps, nextState) {
    ...
    const rightBtn = ReactDOM.findDOMNode(this.refs.rightBtn);
        // debugger
    ...
    return (<div className="chartWrapper">
      ...
      <div className="panel">
        ...
        <div className="panelBody">
          ...
          <div ref="allSellersLineChart" className="allSellersLineChart" />
        </div>
      </div>
      <div className="panel">
